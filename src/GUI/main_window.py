...
from ..Movie import *
from .. import db_calls as dbc
from ..API import API_request as apir
from ..API.json_to_Movie import genre_list
from ..API.json_to_Movie import responses_to_movies
...
class MainWindow(Tk):
    ...
    def __init__(self, db_name, table_name):
        ...
        self.optionMenu_category = OptionMenu(
            frame_category,
        ...
        tooltip_no_KEY = Hovertip(
            self.label_no_API,
            "The movie database will be loaded using a local json file.",
        )
        ...
        self.button_draw.grid(
            row=4, column=0, sticky="ns", padx=5, pady=5, columnspan=2
        )
